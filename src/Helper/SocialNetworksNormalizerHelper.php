...
class SocialNetworksNormalizerHelper
{
    ...
    private static function getUrl(SocialNetworkEnum $socialNetwork, string $username): ?string
    {
        return self::getBaseUrl($socialNetwork).$username;
    }

    private static function getBaseUrl(SocialNetworkEnum $socialNetworkEnum): string
    {
