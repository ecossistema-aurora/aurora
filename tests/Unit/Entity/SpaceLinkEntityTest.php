...
class SpaceLinkEntityTest extends TestCase
{
    public function testGetters(): void
    {
        ...
        $this->assertSame(true, $spaceLinkEntity->isAgent());
        $this->assertSame(true, $spaceLinkEntity->isEvent());
        $this->assertSame(true, $spaceLinkEntity->isInitiative());
        $this->assertSame(false, $spaceLinkEntity->isSpace());
        $this->assertSame(false, $spaceLinkEntity->isOpportunity());
        $this->assertSame(false, $spaceLinkEntity->isOrganization());
    }
