...
final class AbstractTimelineDocumentServiceTest extends KernelTestCase
{
    ...
    public function testGetEventsByEntityId(): void
    {
        ...
        $timelineDocumentService = $this->createAbstractClass($this->documentManager, OrganizationTimeline::class);
    ...
    private function createAbstractClass(DocumentManager $documentManager, string $documentClass): AbstractTimelineDocumentService
    {
        return new class ($documentManager, $documentClass) extends AbstractTimelineDocumentService {
        };
    }
}
