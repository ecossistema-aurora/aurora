...
class ArchitecturalAccessibilityAdminController extends AbstractWebController
{
    ...
    public function add(Request $request): Response
    {
        ...
        try {
            ...
            $this->addFlash(
                ...
                $this->translator->trans('accessibility_created')
            );
    ...
    {
        try {
            $accessibility = $this->architecturalAccessibilityService->get(Uuid::fromString($id));
        } catch (Exception $exception) {
        ...
        try {
            ...
            $this->addFlash(
                FlashMessageTypeEnum::SUCCESS->value,
                $this->translator->trans('accessibility_updated')
            );
    ...
    public function remove(string $id): Response
    {
        try {
            ...
            $this->addFlash(
                FlashMessageTypeEnum::SUCCESS->value,
                $this->translator->trans('accessibility_deleted')
            );
        } catch (Exception $exception) {
            $this->addFlash(FlashMessageTypeEnum::ERROR->value, $exception->getMessage());
        }
